...
describe('Classes de Equivalência - Classes Válidas', () => {
    beforeEach(() => {
    ...
    it('Classes Válidas', () => {
      ...
      preencherFormulário(
        ...
        //verifica se o cadastro foi realizado com sucesso ao ser redirecionado para a tela de login com sucesso
