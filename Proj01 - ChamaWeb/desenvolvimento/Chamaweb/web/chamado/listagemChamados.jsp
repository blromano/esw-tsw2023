        ...
        <tbody>
          ...
          <c:forEach var="chamado" items="${servicosCham.todos}">
            <tr>
              ...
              <td><a class="link-light" href="${cp}/processaChamados?acao=prepararAlteracao&id=${chamado.id}&idUsuarioAtual=${requestScope.idUsuarioAtual}&tipoUsuarioAtual=${requestScope.tipoUsuarioAtual}">Acessar</a></td>
            </tr>
          </c:forEach>
        </tbody>
      </table>
