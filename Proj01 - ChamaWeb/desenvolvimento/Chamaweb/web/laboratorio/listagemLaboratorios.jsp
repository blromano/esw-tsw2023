            ...
            <c:forEach items="${servicos.todos}" var="laboratorio">
              <tr>
                ...
                <td style="text-align: right; padding-right:20px;"> 
                    <a class="link-light" href="${cp}/processaLaboratorios?acao=prepararAlteracao&id=${laboratorio.id}" >Editar</a>
                </td>
              </tr>
            </c:forEach>
          </tbody>
        </table>
        <button type="button" class="btn btn-primary" onclick="window.open('${cp}/laboratorio/cadastroLaboratorio.jsp', '_self')">Cadastrar Laboratório</button>
    </div>
  </main>
