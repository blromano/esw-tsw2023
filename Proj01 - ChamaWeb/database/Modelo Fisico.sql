...
ALTER TABLE CHAMADOS ADD CONSTRAINT FK_CHAMADOS_3
    FOREIGN KEY (FK_USUARIOS_USR_ID, FK_USUARIOS_USR_ID_TECNICO)
    REFERENCES USUARIOS (USR_ID, USR_ID)
    ON DELETE CASCADE;
